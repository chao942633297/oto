...
class BootstrapDetailed extends Paginator
{
    ...
    {
        $val = isset($_GET['page'])?$_GET['page']:'';
        $gotohtml="<li><form action='' method='get' name='myform'><span><input type='text' name='page' value='{$val}' style='width: 40px;'> <input type='submit' id='myform' value='GO'> </span></form></li>";
        return $gotohtml;
