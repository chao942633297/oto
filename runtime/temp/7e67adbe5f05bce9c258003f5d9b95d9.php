<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"C:\xampp\htdocs\tpadmin\public/../application/admin\view\index.html";i:1507716545;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="footer">
            <div class="pull-right">&copy; 2017-2019 
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
